"""
Django settings for otomatiki project.
...
SECRET_KEY = 'django-insecure-19@u8@9n0@ag%6+_dmoh_srb+_1e_pbnbmg&ush59na5cul^b#'
...
WSGI_APPLICATION = 'otomatiki.wsgi.application'
